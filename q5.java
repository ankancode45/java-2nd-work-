...
class User {
    ...
    // Method to find and purchase a laptop
...
class LaptopPurchaseSystem {
    ...
    // Method to create laptops and a user and find and purchase a laptop
    public static void createAndEvaluateLaptops() {
        ...
        user.setAddress("Entally, Kolkata");

        user.findAndPurchaseLaptop(laptops);
    }

    public static void main(String[] args) {
        // Main method to create laptops and evaluate
        createAndEvaluateLaptops();
    }
}